...
export const infoBoxes: InfoBoxData[] = [
  ...
  { value: 7, label: "Event", icon: "fa-calendar-check-o", bgColor: "bg-tealbox" },
  { value: 4, label: "Holiday", icon: "fa-umbrella", bgColor: "bg-pinkbox" },
  { value: 1, label: "Visitor Information", icon: "fa-user-secret", bgColor: "bg-purplebox" },
];
...
export const profileDetails: ProfileDetailData[] = [
  { icon: "fa-user", label: "Username", value: "receptionist" },
  { icon: "fa-envelope", label: "Email", value: "user2@example.com" },
  { icon: "fa-phone", label: "Phone", value: "+44079 0532 3213" },
  { icon: "fa-globe", label: "Address", value: "38 Worthy Lane MAVESYN RIDWARE WS15 0QS" },
];
