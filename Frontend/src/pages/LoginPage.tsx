...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-bodyBg text-[#41403F] flex items-center justify-center p-4 sm:p-6 md:p-8 animate-fadeIn">
            ...
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
              {({ errors, touched, isSubmitting, setFieldValue }) => {
                ...
                return (
                  <>
                    {loginError && (
                      <div role="alert" className="mb-4 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600 animate-fadeIn">
                        {loginError}
                      </div>
                    )}
                    <Form className="space-y-6 mb-8">
                      ...
                      <button
                        ...
                        className="w-full py-3.5 bg-primary hover:bg-orange-600 active:bg-orange-700 text-white font-bold text-base rounded-md uppercase transition duration-150 ease-in-out tracking-wider shadow-md hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-70 active:scale-[0.99]"
                      >
