...
export function ReceptionistDashboard() {
    ...
    if (error || !dashboard) {
        return (
            <DashboardLayout>
                <div className="p-6">
                    <ErrorMessage message={error || "Failed to load dashboard"} onRetry={() => fetchDashboard("Receptionist")} />
                </div>
            </DashboardLayout>
        );
    }
    ...
    return (
        <DashboardLayout>
            ...
            <DashboardHeaderBar roleName="Receptionist" />
